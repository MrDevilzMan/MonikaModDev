...
label mas_mood_scared:
    ...
    m 3b "The trick on playing confident is to keep a cool exterior with your head leveled just above the shoulder.
    ...
    m 1k "Your one and only believes in you, so you can face that anxiety head-on!"
